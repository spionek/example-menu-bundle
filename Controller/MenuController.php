...
use Spionek\ExampleMenuBundle\Form\MenuType;
...
class MenuController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SpionekExampleMenuBundle:Menu')->findAll();
     ...
     * @Method("POST")
     * @Template("SpionekExampleMenuBundle:Menu:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SpionekExampleMenuBundle:Menu')->find($id);
     ...
     * @Method("PUT")
     * @Template("SpionekExampleMenuBundle:Menu:edit.html.twig")
     */
